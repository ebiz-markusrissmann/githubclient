...
import { WorkflowRun } from '../src/data/workflow-run';
import { IRepository } from '../src/interfaces/responses/i-repository';
import { IRepositoryOwner } from '../src/interfaces/responses/i-repository-owner';
import { IHeadRepository } from '../src/interfaces/responses/i-head-repository';
...
describe('Test github-workflow.ts', () => {
  ...
  it('Test ListWorkflows', async () => {
    ...
    const githubWorkflow = new GithubWorkflow(octokitMock, apiVersion, errorHandler);
  ...
  it('Test ListWorkflows -> 404', async () => {
    ...
    const githubWorkflow = new GithubWorkflow(octokitMock, '2022-11-28', errorHandler);
  ...
  it('Test GetWorkflowRun', async () => {
    const repositoryOwner: IRepositoryOwner = {
      login: '',
      id: 0,
      node_id: '',
      avatar_url: '',
    ...
    const headRepository: IHeadRepository = {
      id: 0,
      node_id: '',
      name: '',
      full_name: '',
