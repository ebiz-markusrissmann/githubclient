...
import { githubSecretListResponse, githubSecret, githubSecretResponse, githubSecretsPublicKeyResponse } from '../src/models/secret';
...
describe('Test github-secrets.ts', () => {
  ...
  it('Test github-secrets.ts -> ListRepositorySecrets', async () => {
    const secret1: githubSecret = {
      created_at: Date().toLocaleString(),
      updated_at: Date().toLocaleString(),
      name: 'Extreme Secret1',
    };
    const secret2: githubSecret = {
      created_at: Date().toLocaleString(),
      updated_at: Date().toLocaleString(),
      name: 'Extreme Secret2',
    };

    const githbuSecretResponse: githubSecretListResponse = {
      total_count: 1,
  ...
  it('Test github-secrets.ts -> GetRepositorySecret', async () => {
    const githubSecretResponse: githubSecretResponse = {
      created_at: Date().toLocaleString(),
      updated_at: Date().toLocaleString(),
      name: 'Extreme Secret2',
    };
  ...
  it('Test github-secrets.ts -> CreateOrUpdateSecret error 2', async () => {
    ...
    const githubSecretsPublicKeyResponse: githubSecretsPublicKeyResponse = {
      data: {
